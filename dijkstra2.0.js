    ...
    if (otricat1 == true){
        if (vsp >= 48 && vsp <= 57){
            ...
            if (str.charCodeAt(0) == 105){ //105 == 'i'
                ERROR = { type: "point", line: 104, i: str[str.length-1], big: true };
                break;
            }
            bober.push("-" + str);
            ...
            ERROR = { type: "int", line: 114, i: i, big: true };
            break;
        }
    }
    else if (otricat2 == true){
        if (vsp != 41){
            ERROR = { type: "rscob", line: 121, i: i, big: true };
            break;
        }
        else {
            err.skob--;
        ...
        if (err.poryad == false){
            let str = search(i,s);
            if (str.charCodeAt(0) == 105){ //105 == 'i'
                ERROR = { type: "point", line: 136, i: str[str.length-1], big: true };
                break;
            }
            bober.push(str);
            ...
            ERROR = { type: "oper", line: 146, i: i, big: true };
            break;
        }
    }
        ...
        if (vsp == 45){
          ...
          continue;
            ...
            ERROR = { type: "int", line: 156, i: i, big: true };
            break;
        }
    }
        ...
        if (err.poryad == true){
            ...
            ERROR = { type: "int", line: 189, i: i, big: true };
            break;
        }
    }
        ...
        if (err.poryad == true){
            ...
            ERROR = { type: "int", line: 222, i: i, big: true };
            break;
        }
    } if (vsp == 94){ // 94  '^'
        if (err.poryad == true){
            ...
            ERROR = { type: "int", line: 267, i: i, big: true };
            break;
        }
    }
    else if (vsp == 40){//40  '('
        if (err.poryad == false){
            ...
            ERROR = { type: "oper", line: 279, i: i, big: true };
            break;
        }
    }
    else if (vsp == 41){ //')' = 41
        if (--err.skob >= 0){
            ...
            ERROR = { type: "skob", line: 293, i: i, big: true };
            break;
        }
    }
    else if (vsp == 46){
        ERROR = { type: "point", line: 298, i: i, big: true };
        break;
    } 
    else {
        console.log("(310) Программа сломалась(" + i + " " + vsp)
    }
    console.log(bober+" "+i)
    console.log(stack)
}
